...
var _Parameter2 = __webpack_require__(184);
...
var _BaseClass2 = __webpack_require__(181);
...
var _EventManage = __webpack_require__(182);
...
var _Cluster = __webpack_require__(172);
...
var _MapConfig = __webpack_require__(169);
...
var _MultiOverlay = __webpack_require__(183);
...
var _MiddleOverlay2 = __webpack_require__(35);

var _MiddleOverlay3 = _interopRequireDefault(_MiddleOverlay2);

var _ImgConfig = __webpack_require__(72);

var _ImgConfig2 = _interopRequireDefault(_ImgConfig);

var _BatchesData = __webpack_require__(73);
...
var _ImgOverlay2 = __webpack_require__(178);
    ...
    _createClass(SSImgOverlay, [{
        ...
        value: function _loopDraw(ctx, pixels, otherMode) {
            ...
            var _loop = function _loop(i, len) {
                var item = pixels[i];
                var pixel = item.geometry.pixel;
                var style = _this2._setDrawStyle(item, otherMode, i);
                if (pixel.x > -style.width && pixel.y > -style.height && pixel.x < mapSize.width + style.width && pixel.y < mapSize.height + style.height) {
...
var _PointOverlay2 = __webpack_require__(179);
...
var _PolygonOverlay2 = __webpack_require__(180);
...
var _CanvasOverlay = __webpack_require__(74);
...
var PolygonImgOverlay = function (_MiddleOverlay) {
    _inherits(PolygonImgOverlay, _MiddleOverlay);

    function PolygonImgOverlay(opts) {
        _classCallCheck(this, PolygonImgOverlay);

        var _this = _possibleConstructorReturn(this, (PolygonImgOverlay.__proto__ || Object.getPrototypeOf(PolygonImgOverlay)).call(this, _ImgConfig2.default, opts));
    ...
    _createClass(PolygonImgOverlay, [{
        key: 'setZIndex',
        value: function setZIndex(zIndex) {
            this._zIndex = zIndex;
            if (this._container) this._container.style.zIndex = this._zIndex;
        ...
        value: function _translation(distanceX, distanceY) {
            for (var i = 0; i < this._workerData.length; i++) {
                ...
                var center = this._workerData[i].geometry.center;
        ...
        value: function _drawMap(callback) {
            ...
            this._postMessage('PolygonOverlay.centerToPixels', parameter, function (pixels, margin) {
                if (_this2._eventType == 'onmoving') {
                    return;
                }
                _this2._setState(_OnStateConfig2.default.conputeAfter);
        ...
        value: function _getTarget(x, y) {
            ...
            for (var i = 0, len = pixels.length; i < len; i++) {
                ...
                if (!img) break;
                if (style.width && style.height) {
                    var xy = this._getDrawXY(center, style.offsets.left, style.offsets.top, style.width, style.height, 1);
                    ...
                    var _xy = this._getDrawXY(center, style.offsets.left, style.offsets.top, style.width, style.height);
                    if (this._isMouseOver(x, y, _xy.x, _xy.y, img.width, img.height)) {
        ...
        key: '_drawPolygon',
        value: function _drawPolygon(data, otherMode) {
            this._ctx.lineCap = 'round';
            this._ctx.lineJoin = 'round';
            this._ctx.miterLimit = 4;
            for (var i = 0; i < data.length; i++) {
            ...
            if (this._styleConfig.normal.label.show) {
                for (var _i2 = 0; _i2 < data.length; _i2++) {
                    ...
                    var _style = this._setDrawStyle(_item, otherMode, _i2);
                    var labelPixels = _geometry.labelPixels;
                    this._ctx.shadowBlur = 0;
                    this._ctx.lineWidth = _style.label.lineWidth;
                    this._ctx.font = _style.label.font;
        ...
        value: function _loopDraw(ctx, pixels, otherMode) {
            ...
            var _loop = function _loop(i, len) {
                var item = pixels[i];
                var center = item.geometry.center;
                var style = _this3._setDrawStyle(item, otherMode, i);
                if (center.x > -style.width && center.y > -style.height && center.x < mapSize.width + style.width && center.y < mapSize.height + style.height) {
                    _this3._loadImg(style.icon, function (img) {
                        if (style.width && style.height) {
                            var xy = _this3._getDrawXY(center, style.offsets.left, style.offsets.top, style.width, style.height);
                            _this3._drawImage(_this3._ctx, img, xy.x, xy.y, style.width, style.height);
                        } else {
                            var _xy2 = _this3._getDrawXY(center, style.offsets.left, style.offsets.top, img.width, img.height, 1);
                            _this3._drawImage(_this3._ctx, img, _xy2.x, _xy2.y, img.width, img.height);
                        }
                    });
                }
        ...
        key: '_drawMousePolygon',
        value: function _drawMousePolygon() {
            var overArr = this._overItem ? [this._overItem] : [];
            if (this._mouseOverShow) {
        ...
        key: 'setSelectd',
        value: function setSelectd(lnglat) {
            var _this4 = this;
            ...
            if (zoom !== zoomValue || center.lng !== point.lng) {
                ...
                setTimeout(function () {
                    _this4.setSelectedMessage(lnglat);
                }, 1000);
                return;
            } else {
        ...
        value: function setSelectedMessage(lnglat) {
            var _this5 = this;
            ...
            this._postMessage('PolygonOverlay.setSelected', parameter, function (postObj) {
    ...
    return PolygonImgOverlay;
}(_MiddleOverlay3.default);

exports.default = PolygonImgOverlay;
...
var _RectConfig = __webpack_require__(171);
...
exports.MarkerClusterer = exports.config = exports.WorkerMrg = exports.SSImgOverlay = exports.PolygonImgOverlay = exports.CircleOverlay = exports.RectOverlay = exports.SSPolygonOverlay = exports.PieOverlay = exports.SSPointOverlay = exports.Map = exports.utils = exports.version = undefined;
...
var _PolygonImgOverlay = __webpack_require__(153);

var _PolygonImgOverlay2 = _interopRequireDefault(_PolygonImgOverlay);
...
var _WorkerMrg = __webpack_require__(104);
...
var inMap = {
    ...
    PolygonImgOverlay: _PolygonImgOverlay2.default,
...
exports.PolygonImgOverlay = _PolygonImgOverlay2.default;
...
var _PolygonConfig = __webpack_require__(170);
...
var _CanvasOverlay2 = __webpack_require__(74);
...
var _ev = __webpack_require__(167);
