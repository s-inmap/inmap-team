...
var _Curive = __webpack_require__(163);
...
var _Polylabel = __webpack_require__(165);
...
var PolygonOverlay = {
    ...
    centerToPixels: function centerToPixels(webObj) {
        var _webObj$request$data2 = webObj.request.data,
            data = _webObj$request$data2.data,
            enable = _webObj$request$data2.enable,
            centerType = _webObj$request$data2.centerType,
            customZoom = _webObj$request$data2.customZoom;
        ...
        for (var j = 0; j < data.length; j++) {
            ...
            if (point) {
                data[j].geometry['center'] = (0, _pointToPixel.pointToPixelWorker)({
                    lng: point[0],
                    lat: point[1]
                }, map);
                point = null;
    ...
    setSelected: function setSelected(webObj) {
        var _webObj$request$data3 = webObj.request.data,
            data = _webObj$request$data3.data,
            filterData = _webObj$request$data3.filterData;
